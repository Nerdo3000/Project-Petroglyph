...
execute as @a[gamemode=!spectator] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{type_specific:{type:"minecraft:player",advancements:{"petroglyph-gembag:gods_eye":1b}}}} run effect give @s minecraft:night_vision 10 0 true
