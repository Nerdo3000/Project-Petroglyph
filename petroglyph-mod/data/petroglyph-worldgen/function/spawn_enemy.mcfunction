...
execute at @s run playsound minecraft:block.trial_spawner.ominous_activate hostile @a[distance=..10] ~ ~ ~ 0.08 0.93
execute at @s run playsound minecraft:item.armor.equip_chain hostile @a[distance=..10] ~ ~ ~ 1 0.73