...
execute as @e[type=husk,tag=mummy_setup] run loot replace entity @s armor.head loot petroglyph-bossfight:mummy_head
execute as @e[type=husk,tag=mummy_setup] run loot replace entity @s armor.chest loot petroglyph-bossfight:mummy_chest
execute as @e[type=husk,tag=mummy_setup] run loot replace entity @s armor.legs loot petroglyph-bossfight:mummy_legs
execute as @e[type=husk,tag=mummy_setup] run loot replace entity @s armor.feet loot petroglyph-bossfight:mummy_feet
