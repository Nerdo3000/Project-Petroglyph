...
execute as @a[scores={petroglyph-hydration_rate=..3}] run title @s actionbar [{"text": "petroglyph-hydration: ","color": "aqua"},{"score": {"name": "@s","objective": "petroglyph-hydration_level"},"color": "aqua"},{"text": "/","color": "aqua"},{"text": "1500 ","color": "aqua"},{"text": " [-","color": "aqua"},{"score":{"name": "@s","objective": "petroglyph-hydration_rate"},"color": "aqua"},{"text": "]","color": "aqua"}]
execute as @a[scores={petroglyph-hydration_rate=4..6}] run title @s actionbar [{"text": "petroglyph-hydration: ","color": "yellow"},{"score": {"name": "@s","objective": "petroglyph-hydration_level"},"color": "yellow"},{"text": "/","color": "yellow"},{"text": "1500 ","color": "yellow"},{"text": " [-","color": "yellow"},{"score":{"name": "@s","objective": "petroglyph-hydration_rate"},"color": "yellow"},{"text": "]","color": "yellow"}]
execute as @a[scores={petroglyph-hydration_rate=7..}] run title @s actionbar [{"text": "petroglyph-hydration: ","color": "red"},{"score": {"name": "@s","objective": "petroglyph-hydration_level"},"color": "red"},{"text": "/","color": "red"},{"text": "1500 ","color": "red"},{"text": " [-","color": "red"},{"score":{"name": "@s","objective": "petroglyph-hydration_rate"},"color": "red"},{"text": "]","color": "red"}]
