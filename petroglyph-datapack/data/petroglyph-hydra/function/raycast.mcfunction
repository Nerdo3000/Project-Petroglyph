...
execute if block ^ ^ ^ #petroglyph-hydra:water run return 1
execute if block ^ ^ ^ #petroglyph-hydra:waterloggable[waterlogged=true] run return 1
execute unless block ^ ^ ^ #petroglyph-hydra:ray_pass_through run return fail
execute positioned ^ ^ ^0.02 run return run function petroglyph-hydra:raycast