...
execute as @a run function petroglyph-bossfight:check_offhand

execute as @e[type=blaze,tag=inferno_base] run function petroglyph-bossfight:tick_inferno
execute as @e[type=item_display,tag=inferno_shield] at @s unless entity @e[type=blaze,tag=inferno_base,distance=..3] run kill @s
