...
execute as @s unless score @s checked_bottles matches 1.. at @s run data modify entity @e[type=item, limit=1, sort=nearest, tag=set_count] Item.count set from entity @p SelectedItem.count
