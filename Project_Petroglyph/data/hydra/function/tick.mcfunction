...
execute as @a if items entity @s weapon.offhand minecraft:glass_bottle at @s anchored eyes run function hydra:raycast_offhand

scoreboard players set @a checked_bottles 0
execute as @a if items entity @s weapon.mainhand minecraft:glass_bottle at @s anchored eyes run function hydra:raycast_mainhand
