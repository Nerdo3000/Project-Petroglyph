...
data modify entity @e[type=item, limit=1, sort=nearest, tag=set_count] Item.count set from entity @s equipment.offhand.count
item modify entity @s weapon.offhand hydra:set_0
