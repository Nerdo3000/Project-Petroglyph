...
#execute if items entity @s weapon.mainhand recovery_compass[minecraft:custom_data~{glass_bottle_fake:{}}] run function hydra:real_bottle_slot with storage bottle
...
#execute if items entity @s weapon.offhand recovery_compass[minecraft:custom_data~{glass_bottle_fake:{}}] run function hydra:real_bottle_slot with storage bottle
