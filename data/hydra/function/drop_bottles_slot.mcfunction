...
execute as @s if score @s checked_bottles matches 2 at @s run data modify entity @e[type=item, limit=1, sort=nearest, tag=set_count] Item.count set from entity @s SelectedItem.count
execute as @s if score @s checked_bottles matches 1 at @s run data modify entity @e[type=item, limit=1, sort=nearest, tag=set_count] Item.count set from entity @s equipment.offhand.count
