...
execute as @a if items entity @s weapon.offhand minecraft:glass_bottle at @s anchored eyes if function hydra:raycast run function hydra:drop_bottles_offhand

scoreboard players set @a hydra.distance_from_start 0
execute as @a if items entity @s weapon.mainhand minecraft:glass_bottle at @s anchored eyes if function hydra:raycast run function hydra:drop_bottles_mainhand
