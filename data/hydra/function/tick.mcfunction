...
execute as @a if score @s checked_bottles matches 1 run function hydra:drop_bottles_offhand
...
execute as @a if score @s checked_bottles matches 1 run function hydra:drop_bottles_mainhand
