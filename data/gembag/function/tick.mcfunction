...
execute as @a[advancements={gembag:orb_jump=true}] run attribute @s minecraft:safe_fall_distance base set 4
execute as @a[advancements={gembag:orb_jump=true}] run attribute @s minecraft:fall_damage_multiplier base set 0.8
...
execute as @a[advancements={gembag:orb_wind=true}] run attribute @s minecraft:jump_strength base set 0.45
